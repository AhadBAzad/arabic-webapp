...
// Debug logging to check parsing
console.log('RAW_TSV sample:', RAW_TSV.substring(0, 100));
console.log('First few lines split:', RAW_TSV.split(/\r?\n/).slice(0, 5));
console.log('Parsed from doc count:', parsedFromDoc.length);
console.log('First parsed phrase:', parsedFromDoc[0]);
