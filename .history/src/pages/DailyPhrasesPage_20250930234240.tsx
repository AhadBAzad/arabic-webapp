...
const DailyPhrasesPage = () => {
  ...
  console.log('Total phrases in database:', dailyPhrasesDatabase.length);
  console.log('Filtered phrases:', filteredPhrases.length);
  console.log('First 5 phrases:', dailyPhrasesDatabase.slice(0, 5));
